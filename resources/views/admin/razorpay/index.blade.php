...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{ route('admin.razorpay.exportData') }}" method="POST">
                    @csrf
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="table" id="table" class="form-select select2" required="">
                                                ...
                                                <option value="rzp_upload" {{ old('table')=='rzp_upload' ? 'selected' : '' }}>Razorpay Upload File</option>
                                                <option value="itc_report" {{ old('table')=='itc_report' ? 'selected' : '' }}>ITC Report</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
